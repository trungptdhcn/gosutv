package com.icom.gosutv.ui.customview;
...
//				textColor);
		...
		// if the tvSapo is empty , so ignore it
	...
	protected void onDraw(Canvas canvas) {
		...
		// Draw the tvSapo (attempts to center it horizontally and vertically)
	...
	/**
	 * Set the tvSapo in the progress bar Doesn't invalidate the view
	 * 
	 * @param text
